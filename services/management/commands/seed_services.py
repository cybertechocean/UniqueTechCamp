...
class Command(BaseCommand):
    help = "Seed database with 110+ comprehensive services with AI Lead Generation, Qualification, and Automated Follow-Up"
    ...
    def handle(self, *args, **options):
        ...
        for idx, item in enumerate(seeded_services):
            ...
            is_feat = (idx % 7 == 0) # highlight select services
